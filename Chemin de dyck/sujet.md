...
1. Créez un clone (*fork*) du [dépôt du projet](https://gitlab.info.uqam.ca/inf3135-sdo/motdedyck).
...
**exactement** `e23-inf3135-tp1` et l'URL devra être **exactement**
`https://gitlab.info.uqam.ca/<utilisateur>/e23-inf3135-tp1`, où
...
- Votre dépôt doit se nommer **exactement** `e23-inf3135-tp1`
...
- Votre dépôt doit être un *fork* du [gabarit fourni](https://gitlab.info.uqam.ca/inf3135-sdo/motdedyck).
